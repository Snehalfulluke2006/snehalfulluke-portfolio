...
export default function StudioGallery() {
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <div>
                <h1 className="text-4xl font-black tracking-tighter mb-2">Gallery</h1>
                <p className="text-white/40">Manage your photography and visual works.</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-32 rounded-[40px] glass border border-white/5 gap-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-white/30 text-sm font-medium">Upload and curate your visual portfolio here.</p>
